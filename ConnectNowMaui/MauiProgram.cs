...
using ConnectNow.Authorization;
using ConnectNow;
using ConnectNow.Views.CustomControls;
using ConnectNow.Validations;
using ConnectNow.ApiService;
using ConnectNow.Services.Theme;
using ConnectNow.Helpers.Mappings;
using AutoMapper;
           ...
           // services.AddSingleton<IApiService, ApiService>();
            ...
            services.AddSingleton<IMapConfig>(new MapConfig
            {
                GoogleMapsApiKey = DeviceInfo.Platform == DevicePlatform.iOS
                    ? "AIzaSyBdKWMwUzqOTlnSZQ1Y1bsygwFHpxapOaA"  // Replace with actual iOS key
                    : "AIzaSyBdKWMwUzqOTlnSZQ1Y1bsygwFHpxapOaA"  // Replace with actual Android key
            });
